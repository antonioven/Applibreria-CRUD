...
function actualizar(i){
    ...
    if(libros[i].titulo === '' || libros[i].descripcion === '' || libros[i].precio === '' ){
        alert("Ha falto de actualizar algunos campos, favor de llenarlos")
    }else{
        localStorage.setItem("Libros", JSON.stringify(libros));
        VistaPrincipal();
    }
...
//Funcion para mostrar nuestra interfaz principal
